...
for f in fee-events.json v4-collects.json memecoin-discovered.json fee-snapshots.json fee-daily.json fee-prices.json backfill.json \
         liquidity-ledger.json v4-liquidity-ledger.json v4-owner-collects.json token-sales.json strategy-proposals.json portfolio.json range-log.json snet-staking.json alerts-state.json \
