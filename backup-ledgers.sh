...
FILES=()
for f in fee-events.json v4-collects.json fee-snapshots.json fee-daily.json fee-prices.json backfill.json \
         liquidity-ledger.json portfolio.json range-log.json snet-staking.json alerts-state.json \
